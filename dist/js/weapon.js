...
Wolf.Weapon = (function () {
    function fireHit(game, player) {
        ...
        Wolf.Sound.startSound(null, null, 0, Wolf.CHAN_WEAPON, "assets/lsfx/023.wav", 1, Wolf.ATTN_NORM, 0);
        dist = 0x7fffffff;
        closest = null;
    ...
    function fireLead(game, player) {
        ...
        switch (player.weapon) {
            case Wolf.WEAPON_PISTOL:
                Wolf.Sound.startSound(null, null, 0, Wolf.CHAN_WEAPON, "assets/sfx/012.wav", 1, Wolf.ATTN_NORM, 0);
                break;
            case Wolf.WEAPON_AUTO:
                Wolf.Sound.startSound(null, null, 0, Wolf.CHAN_WEAPON, "assets/sfx/011.wav", 1, Wolf.ATTN_NORM, 0);
                break;
            case Wolf.WEAPON_CHAIN:
                Wolf.Sound.startSound(null, null, 0, Wolf.CHAN_WEAPON, "assets/sfx/013.wav", 1, Wolf.ATTN_NORM, 0);
                break;
        }
        ...
        if (!closest) {
            ...
            if (tracePoint.flags & Wolf.TRACE_HIT_DOOR) {
                Wolf.Sound.startSound(null, null, 0, Wolf.CHAN_AUTO, "assets/lsfx/028.wav", 1, Wolf.ATTN_NORM, 0);
            }
            return;
        }
